...
def predictor_command_parser(parser):
	parser.add_argument('-fr', dest='framework', choices=['ktf', 'kth', 'th', 'tf'], help='framework, [keras-tensorflow backend, keras-theano backend, theano, tensorflow]', default='ktf')
	...
	parser.add_argument('--max_length', help='Maximum length of sequences during training (for RNNs)', default=50, type=int)
